...
namespace _08_Interfaces
{
    ...
    public class TransactionTests
    {
        ...
        {
            _debt -= payment.Value;
            Console.WriteLine($"you have paied ${payment.Value} towards your debt");
        }
        ...
        public void InjectionIntoConstructor()
        {
            ...
            var secondTransaction = new Transaction(epayment); // dependent on it because of how we codded it

    ...
    public class ProgramUI
        {
            ...
            {
                Movie toyStory = new Movie("Toy Store", "Two plastic bros trauma bond", 5, MaturityRating.PG, GenreType.Bromance, 120, 1994);
            ...
            Episode episode4 = new Episode("the ganag does a thing", 22, 10, 1);

            Show always = new Show("always sunny", "four drunks yell at each other", 5, MaturityRating.TV_MA, GenreType.Comedy, 15, new List<Episode>()
            { episode3,episode2,episode4,episode1});
            ...
            private void DisplayContent(StreamingContent content)
            {
                ...
                else if (content is Show)
                {
                     ...
                     _console.WriteLine($"average run time: {show.AverageRunTime}\n" +
                           $"number of seasons: {show.NumberOfSeasnons}\n");
